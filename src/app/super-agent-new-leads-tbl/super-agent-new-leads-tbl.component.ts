...
@Component({
  selector: 'app-super-agent-new-leads-tbl',
  templateUrl: './super-agent-new-leads-tbl.component.html',
  styleUrls: ['./super-agent-new-leads-tbl.component.css']
})
export class SuperAgentNewLeadsTblComponent implements OnInit {
  agentListData: any;
